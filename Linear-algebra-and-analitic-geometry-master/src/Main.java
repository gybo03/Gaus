...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Razdaljina od "+plane1.getName()+" do "+plane2.getName()+" = "+Plane.distanceBetweenTwoPlanes(plane1, plane2));*/
        //</editor-fold>
        ...
        *///</editor-fold>
        ...
        System.out.println("Razdaljina izmedju "+plane1.getName()+" i "+point3.getName()+" je "+Plane.distanceBetweenPointAndPlane(point3,plane1));*/
        //</editor-fold>
